...
public class ControlsController implements Initializable{
	...
	private void backwardPressed(){
		Main.mediaplayer.backwardPressed();
	}
	@FXML
	...
	public void updateControls() {		
    	if(!Main.mediaplayer.isPlaying()){
    		Main.controlsController.playpause.setImage(Main.controlsController.playIcon);
    	}else{
    		Main.controlsController.playpause.setImage(Main.controlsController.pauseIcon);
    	}
	}
